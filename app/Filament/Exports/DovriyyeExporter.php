...
class DovriyyeExporter extends Exporter
{
    ...
    {
        //  dd(app(Dovriyye_analitic::class)->Debitor()->get());
        return app(Dovriyye_analitic::class)->Debitor();
    }
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('borc_yanvar_2025')
                ->label('01.01.2026'),
            ExportColumn::make('borc_yanvar_2026')
                ->label('01.01.2026'),
            ExportColumn::make('hesablanma_mart_2026')
                ->label('Hesablanma - 01.03.2026'),
            ExportColumn::make('cixis_mart_2026')
                ->label('31.03.2026'),
